...
class Field:
    """Simulation of a field containing animals and crops"""
...
def manual_grow(field):
    ...
    while not valid:
        try:
            ...
            print("Value entered is not valid - please enter a value be=tween 1 and 100")
    field.grow(light, food, water)
...
def display_animal_menu():
    ...
    print()
    print("Please select an optin from the above menu")
...
def manage_field(field):
    ...
    while not exit:
        ...
        if option == 1:
            ...
            exit = True
            print()
        print("Thank you for using the field management system")
